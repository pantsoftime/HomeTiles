...
esp_lcd_touch_handle_t touch_gt911_init(DEV_I2C_Port port)
{
    ...
    const esp_lcd_touch_config_t tp_cfg = {
        ...
        .flags = {
            ...
            .mirror_x = 1,  // Mirror X for the native 7B touch orientation
            .mirror_y = 1,  // Mirror Y for the native 7B touch orientation
        },
    };
...
static esp_err_t touch_gt911_read_cfg(esp_lcd_touch_handle_t tp)
{
    ...
    Serial.printf("[Device/Waveshare Touch LCD 7B] TouchPad_ID:%02X%02X%02X cfg=%u\n",
