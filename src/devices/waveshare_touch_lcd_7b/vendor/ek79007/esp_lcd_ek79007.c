...
// The upstream component CMake generates these version definitions. Arduino
// compiles the vendored source directly, so provide the matching upstream
// component version when that generated build metadata is absent.
