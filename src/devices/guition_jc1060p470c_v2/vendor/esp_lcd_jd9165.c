...
static const jd9165_lcd_init_cmd_t guition_jc1060p470c_v2_init_cmds[] = {
    // Exact Guition 2026 V2 "New Panel" vendor sequence.
...
static esp_err_t panel_jd9165_init(esp_lcd_panel_t *panel)
{
    ...
    if (jd9165->init_cmds) {
        ...
        init_cmds_size = sizeof(guition_jc1060p470c_v2_init_cmds) /
                         sizeof(jd9165_lcd_init_cmd_t);
    }
