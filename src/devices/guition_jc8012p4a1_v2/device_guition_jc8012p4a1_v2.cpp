...
p4_dsi_ui_ppa::Client g_ui_ppa("Guition JC8012P4A1 V2");
...
bool draw_landscape_area(int32_t x, int32_t y, int32_t w, int32_t h, const uint16_t* data) {
  ...
  // Use the established wide-band PPA policy from the Waveshare 8-inch driver.
...
bool DeviceGuitionJC8012P4A1V2::ppaCooldownActive() {
