 ...
 *
 * Imported for HomeTiles from the Guition JC8012P4A1 V2 new-panel bundle
 * reported and hardware-tested in HomeTiles issue #18. This table is kept
 * separate from the V1 target so firmware and OTA images cannot be mixed.
 */
...
static const jd9365_lcd_init_cmd_t guition_jc8012p4a1_v2_init_cmds[] = {
...
static constexpr size_t guition_jc8012p4a1_v2_init_cmds_count =
    sizeof(guition_jc8012p4a1_v2_init_cmds) /
    sizeof(guition_jc8012p4a1_v2_init_cmds[0]);
