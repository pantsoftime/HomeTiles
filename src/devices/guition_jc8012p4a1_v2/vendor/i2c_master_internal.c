// Exact-profile backport of Espressif 37758ef327f9 onto Arduino 3.3.7's IDF.
// See I2C_BACKPORT.md for provenance and the dump evidence.
#include "src/devices/device_select.h"
#if defined(DEVICE_GUITION_JC8012P4A1_V2)
#include "esp_idf_version.h"
#if ESP_IDF_VERSION != ESP_IDF_VERSION_VAL(5, 5, 2)
#error "Review the Guition V2 I2C backport when updating ESP-IDF"
#endif
