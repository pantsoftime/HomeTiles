 ...
 *
 * Vendored from espressif/esp-video-components esp_cam_sensor 2.6.0
 * (commit dbbdcbd5e25bdb6561d3f7fd0c5149641ba5536f), sensors/sc202cs:
 * include/sc202cs_types.h (register type), private_include/sc202cs_regs.h
 * (register names) and private_include/
 * sc202cs_mipi_1lane_24Minput_1280x720_raw8_30fps.h (mode table). The table
 * is byte-for-byte; see PROVENANCE.md for hashes.
 */
